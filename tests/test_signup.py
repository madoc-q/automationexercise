...
def test_first_signup(first_page):
    ...
    first.first_signup("Madoc Quaye", "quaye.madoc@gmail.com")
...
@pytest.mark.parametrize(
    ...
    [
        # missing title
        ("", "Madoc Quaye", "Godisgood", "Madoc", "Quaye", "Accra", "India", "Greater Accra", "Accra", "233", "0244994030"),
        # missing name and password
        ("id_gender1", "", "", "Madoc", "", "Accra", "India", "Greater Accra", "Accra", "233", "0244994030"),
        # missing password
        ("id_gender1", "Madoc Quaye", "", "Madoc", "", "Accra", "India", "Greater Accra", "Accra", "233", "0244994030"),
    ],
)
